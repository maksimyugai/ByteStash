-- Squashed initial schema. Mirrors server/src/config/schema/init.sql from the
-- Node/SQLite version (the end state of all 11 runtime migrations), so an
-- existing snippets.db can be imported with a data-only dump.
